...
import com.paschoalini.cursomc.domain.Pagamento;
import com.paschoalini.cursomc.domain.PagamentoComBoleto;
import com.paschoalini.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "363.789.123-77", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "ana@gmail.com", "316.283.827-40", TipoCliente.PESSOAFISICA, pe.encode("123"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "28.777-012", cli2, c2);
